...
DATABASE_PATHNAME = "/Users/yangjie/mywork/workspace/mypython/com/office/pubmed/hl/template2/db/chem0426.db"
'''启动的进程数'''
PROCESS_NUM=16
'''#谷歌浏览器驱动的路径'''
